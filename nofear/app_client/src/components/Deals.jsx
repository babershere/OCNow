...
class Deals extends React.Component {
    ...
    getDeals = async () => {
        const deals_api_call = await fetch(`https://api.discountapi.com/v2/deals?api_key=${DEALS_API_KEY};per_page=10;location=${this.props.city}+ca;radius=3`);
